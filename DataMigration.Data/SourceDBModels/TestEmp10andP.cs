...
{
    public partial class TestEmp10andP
    {
        public string FirstName { get; set; }
        public string LastName { get; set; }
        public string Nickname { get; set; }
        public string PsgldepartmentCode { get; set; }
        ...
        public int? HouseAccountFlag { get; set; }
        public string Tzl8cd { get; set; }
        public string Tzclce { get; set; }
        public string Tzcgce { get; set; }
        public string Tzcjce { get; set; }
        public string Tzsqad { get; set; }
        public string Tzcono { get; set; }
        public string Tzl6cd { get; set; }
    }
}
